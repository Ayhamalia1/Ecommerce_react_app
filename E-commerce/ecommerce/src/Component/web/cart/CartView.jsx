...
export default function CartView() {
    ...
    const {deleteCartProductContext,clearAll}=useContext(CartContext)

    const getCartData=async()=>{
        return await getCartProductContext()
    }
    const deleteProduct=async(id)=>{
        const res=await deleteCartProductContext(id)
        return res
        }
   ...
   const{data}= useQuery("catr data",getCartData)
            ...
            <div className="products" id="products">
                ...
                data && data.products.map((product)=>
                    ...
                    <div className="product-info">
                      ...
                      <div className="product-details">
                        ...
                        <a href="#" onClick={()=>{deleteProduct(product._id)}} className='text-danger'>
                          <svg
              ...
              }
              {
                ...
                data && data.products[0] &&
                  <button className={`bg-danger clearBtn`} > Clear all</button>
                }
            </div>
            <div className="cart-summary">
              ...
              <div className="summery-items">
                ...
                <div className="checkout">
                  <a href="#"><Link to='/order'>Check out</Link></a>
                </div>
              </div>
            </div>
          </div>
